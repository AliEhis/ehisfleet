...
<li><a href="../receipts" class="active">Receipt</a></li>
...
<li style="margin-left:110px; margin-top:10px;">
  <input name="do_receipt" type="button" class="buttons" id="do_receipt" value="Save" style="margin:0;" />
 </li>
 </ul>
