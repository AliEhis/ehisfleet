...
<ul>
<li><a href="../remove-clients">Remove Clients</a></li>
<li><a href="../edit-clients" class="active">Edit Clients</a></li>
<li><a href="../view-clients">View Clients</a></li>
...
<table border="0" class="table table-dark table-bordered table-striped" id="delClientTable" width="100%"  >
    <tbody>
    <tr>
