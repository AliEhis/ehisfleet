...
<li><a href="editStaff.php"  class="active" ><strong>Edit Staff</strong></a></li>
...
<div class='two_column_numbers'>
	...
	<table border="0" class="table table-dark table-bordered table-striped" id="delStaffTable" width="500"  >
    <tbody>
    <tr>
...
<div class="close"> <img src="../../images/close.png" width="42" height="42" id="cls"/></div>
