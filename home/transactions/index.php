...
<li><a href="" class="active">Post Transaction</a></li>
</ul>
</div>
...
<?=  showClients("inpElemts", "<a href='#' class='sm' onclick='$('.dialog').modal()'>Add</a>") ?>
 </li>
 <br clear="all" />
 <li class="lt">Type</li>
 <li class="inpElemts">
     ...
     <label>
       <input type="radio" name="type" value="Debit" id="type_0"  onclick="$('#amountDiv').fadeOut()" />
       Debit</label>
     <label>
       <input type="radio" name="type" value="Credit" id="type_1" onclick="$('#amountDiv').fadeIn()" />
       Credit</label>
...
<br clear="all" />
<div id="amountDiv" style="display:none; width:auto;">
...
<li style="margin-left:110px; margin-top:10px;">
  <input name="do_trans" type="button" class="buttons" id="do_trans" value="Save" style="margin:0;" />
