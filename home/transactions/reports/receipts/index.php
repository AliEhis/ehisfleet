...
<span>Issued Receipts</span>
<ul>


<li><a href="../expenses">Expenses</a></li>
<li><a href="../invoices">Invoices</a></li>
<li><a href="../receipts" class="active">Receipts</a></li>
...
<?php
            $selStaff = mysql_query("SELECT * FROM receipt") or die(mysql_error());
...
<?php
	...
	while(	$showStaff = mysql_fetch_array($selStaff))
	{
        ...
        <td id="<?=$showStaff['id']?>"><?= $showStaff['rn']?></td>
        <td id="<?=$showStaff['id']?>">
	...
	$sqlTotalCredit = mysql_query("SELECT SUM(amount) FROM receipt") or die(mysql_error());
	...
	?>
            <tr class="gradeX">
          <td id="<?=$showStaff['id']?>">        
          <td id="<?=$showStaff['id']?>">Total</td>
          <td id="<?=$showStaff['id']?>">&nbsp;</td>
          <td id="<?=$showStaff['id']?>">&nbsp;</td>
          <td id="<?=$showStaff['id']?>">₦<?= doNum($resC['SUM(amount)'])?></td>
          <td id="<?=$showStaff['id']?>">&nbsp;</td>
          <td id="<?=$showStaff['id']?>">&nbsp;</td>
          <td id="<?=$showStaff['id']?>">&nbsp;</td>
        </tr>
