...
<?php
            $selStaff = mysql_query("SELECT * FROM invoices") or die(mysql_error());
...
<?php
	...
	{
		$t;
		if(($showStaff['tax']=="0") || ( $showStaff['amount']=="0"))
		{
			$t = 0;
		}
		else
        ...
        <td id="<?=$showStaff['id']?>"><?=$showStaff['nots']?></td>
        <td id="<?=$showStaff['id']?>"><?=$showStaff['trips']?></td>
        <td id="<?=$showStaff['id']?>"><?= $showStaff['dates']?></td>

        <td id="<?=$showStaff['id']?>"><?= $t ?>%</td>
        <td id="<?=$showStaff['id']?>">₦          <?=doNum($showStaff['amount'])?></td>
        
        <td id="<?=$showStaff['id']?>"><a href="#" id="printTransact"> <img src="../../../images/print.png" width="16" height="16" border="0"  /></a></td>
        
        <td id="<?=$showStaff['id']?>"><a href="#" id="hideTransact"> <img src="../../../images/hide_table_row.png" width="16" height="16" border="0"  /></a></td>
